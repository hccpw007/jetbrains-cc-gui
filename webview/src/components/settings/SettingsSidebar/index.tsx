...
export type SettingsTab = 'basic' | 'providers' | 'dependencies' | 'usage' | 'permissions' | 'promptEnhancer' | 'commit' | 'mcp' | 'agents' | 'prompts' | 'skills' | 'pet' | 'other' | 'community' | 'visionMcp';
...
const sidebarItems: SidebarItem[] = [
  ...
  { key: 'visionMcp', icon: 'codicon-eye', labelKey: 'settings.visionMcp.title' },
